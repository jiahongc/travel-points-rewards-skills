...
- Notable neighborhoods/districts and what they're known for
...
Every briefing MUST end with this section. Flag data freshness and uncertainty:
...
- **No sources footer**: Do not include a bibliography or sources list
- **No trailing summary**: End with Confidence Notes, not a recap
